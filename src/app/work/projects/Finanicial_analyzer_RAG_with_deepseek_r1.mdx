---
title: "Financial Reports Analyzer RAG: AI-powered Insight Extraction from Financial Documents"
publishedAt: "2025-02-15"
summary: "Developed an AI-powered system leveraging Retrieval-Augmented Generation (RAG) to analyze financial reports. Integrated LLMs, vector databases, and NLP techniques to provide accurate and real-time financial insights."
images:
  - "/images/work/Financial_analyzer_RAG/0_thinking.png"
team:
...
![DeepSeek R1 is Thinking](/images/work/Financial_analyzer_RAG/0_thinking.png)

> Backend Result of Prompt
![Backend Result of Prompt](/images/work/Financial_analyzer_RAG/2_backend.png)

...
export default function About() {
  ...
  <>
    <Heading as="h2" id={about.projects.title} variant="display-strong-l" marginBottom="xl">
      {about.projects.title}
    </Heading>
    <Column fillWidth gap="xl" marginBottom="40">
      {about.projects.projectsList.map((project, index) => (
        <Column
        ...
        >
          ...
          <Flex gap="8" wrap>
            {project.technologies.map((tech, idx) => (
              <Tag key={`${project.name}-${idx}`} size="l" background="brand-weak" padding="s">
                {tech}
              </Tag>
            ))}
          </Flex>
            ...
            <>
              ...
              <Column fillWidth gap="l" marginBottom="40">
                {about.projects.projectsList.map((project, index) => (
                  <Column
                    key={`${project.name}-${index}`}
                    background="neutral-weak" // Adjust to match the overall page theme
                    padding="l"
                    radius="l"
                    shadow="s" // Subtle shadow for depth without contrast
                    border="neutral-medium" // Ensures it blends smoothly
                    fillWidth
                  >
                    <Flex fillWidth horizontal="space-between" vertical="center" marginBottom="s">
                      <Text id={project.name} variant="heading-strong-m">
                        {project.name}
                      </Text>
                      <Text variant="heading-default-xs" onBackground="neutral-weak">
                        {project.timeframe}
                    ...
                    <Flex wrap gap="8">
                      {project.technologies.map((tech, idx) => (
                        <Tag key={`${project.name}-${idx}`} size="m" background="brand-alpha-weak" padding="s">
                          {tech}
                        </Tag>
                      ))}
                    </Flex>
